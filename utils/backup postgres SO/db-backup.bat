...
"C:\Program Files\PostgreSQL\15\bin\pg_dump" -U postgres -d db_lubri_campeon -f "D:\Sistema\Backup\backup.sql"

REM nos movemos a la ruta del .sql
cd "D:\Sistema\Backup"

REM Comprimir el archivo de respaldo en formato .rar
"C:\Program Files (x86)\WinRAR\WinRAR.exe" a "D:\Sistema\Backup\backup_%fecha%_%hora%.rar" "backup.sql"

REM Eliminar el archivo de respaldo sin comprimir
del "D:\Backup\backup.sql"
